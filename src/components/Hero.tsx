...
const Hero = () => {
  ...
  return (
    <div 
      ref={heroRef}
      className="min-h-screen w-full hero-grid pt-24 pb-16 opacity-0 transition-opacity duration-1000"
    >
      <div className="container mx-auto px-4 md:px-6 h-full">
        <div className="flex flex-col md:flex-row items-center justify-between h-full">
          <div className="w-full md:w-1/2 mb-10 md:mb-0">
            <div className="max-w-xl space-y-6">
              <h2 className="text-tech-neon font-medium text-xl opacity-0 animate-fade-in animate-delay-100">
                // PROFESSIONAL SERVICES
              </h2>
              
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight opacity-0 animate-fade-in animate-delay-200">
              ...
              <p className="text-gray-300 text-lg opacity-0 animate-fade-in animate-delay-300">
